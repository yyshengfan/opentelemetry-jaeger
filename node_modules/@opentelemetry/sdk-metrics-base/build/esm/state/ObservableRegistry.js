...
var ObservableRegistry = /** @class */ (function () {
     ...
     */
    ObservableRegistry.prototype.observe = function (timeoutMillis) {
        return __awaiter(this, void 0, void 0, function () {
            var callbackFutures, batchCallbackFutures, results, rejections;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        callbackFutures = this._observeCallbacks(timeoutMillis);
                        batchCallbackFutures = this._observeBatchCallbacks(timeoutMillis);
    ...
    ObservableRegistry.prototype._observeCallbacks = function (timeoutMillis) {
        var _this = this;
    ...
    ObservableRegistry.prototype._observeBatchCallbacks = function (timeoutMillis) {
        var _this = this;
